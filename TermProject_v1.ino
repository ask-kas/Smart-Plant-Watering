...
const int maxADC = 2400, minADC = 1900; //NEED TO TEST SENSOR
...
class WateringDetails{
  ...
  public:
    WateringDetails(int tankHeight = 200, int min_moist_percent = 40, int waterschedloop = 1, int waterschedincrement = 0, int waterschedstart = 800, int minLevel=30){
